export const uttarakhandPackages = [
  {
    id: 1,
    title: '3 Nights / 4 Days Haridwar – Rishikesh – Mussoorie Tour Package',
    shortTitle: 'Haridwar - Rishikesh - Mussoorie',
    ...
    itinerary: [
      {
        day: 1,
        title: 'Arrival in Haridwar & Local Sightseeing',
        details: [
          'Arrive at Haridwar railway station / bus stand',
          'Meet & greet by our representative and transfer to hotel',
          'Visit Mansa Devi Temple, Chandi Devi Temple (by cable car), Daksha Mahadev Temple',
          'Har Ki Pauri Ghat for evening Ganga Aarti',
          'Overnight stay at Haridwar'
        ]
      },
      {
        day: 2,
        title: 'Haridwar → Rishikesh → Mussoorie (90 km / 4–5 hrs)',
        details: [
          'After breakfast, drive to Rishikesh',
          'Visit Ram Jhula & Laxman Jhula, Parmarth Niketan Ashram, Triveni Ghat',
          'Optional: River rafting (seasonal, extra cost)',
          'Proceed to Mussoorie, evening at leisure on Mall Road',
      ...
      },
      {
        ...
        details: [
          'Explore the Queen of Hills after breakfast',
          'Visit Kempty Falls, Gun Hill Point (ropeway optional), Company Garden',
          'Lal Tibba (highest point of Mussoorie), Camel\'s Back Road walk',
      ...
      {
        day: 4,
        title: 'Mussoorie → Haridwar Departure (90 km / 4–5 hrs)',
        details: [
          'After breakfast, check out from hotel',
          'Drive back to Haridwar',
          'Drop at Haridwar railway station / bus stand for onward journey'
        ]
      }
    ],
    inclusions: [
      '3 Nights accommodation (1N Haridwar + 2N Mussoorie)',
    ...
    exclusions: [
      'Any train/air fare',
      'River rafting / ropeway / adventure activities',
      'Personal expenses (laundry, tips, phone calls, etc.)',
      'Entry fees at monuments / parks'
    ],
    activities: ['Temple visits', 'Scenic drives', 'Adventure activities', 'Shopping'],
    bestFor: 'First-time visitors and spiritual seekers'
  },
  {
    id: 2,
    title: '2 Nights / 3 Days Haridwar – Rishikesh Tour Package',
    shortTitle: 'Haridwar - Rishikesh Express',
    ...
    itinerary: [
      {
        ...
        details: [
          ...
          'Visit Mansa Devi Temple, Chandi Devi Temple (by ropeway), Bharat Mata Mandir',
          'Daksha Mahadev Temple, Har Ki Pauri for evening Ganga Aarti',
          'Overnight stay at Haridwar'
        ]
      },
      {
        day: 2,
        title: 'Haridwar → Rishikesh Sightseeing (30 km / 1 hr)',
        details: [
          'After breakfast, drive to Rishikesh',
          'Visit Ram Jhula & Laxman Jhula, Parmarth Niketan Ashram, Triveni Ghat',
          'Beatles Ashram (optional visit), local market shopping',
          'Optional: River rafting or zipline adventure (seasonal, extra cost)',
          'Evening return to Haridwar, overnight stay'
        ]
      },
      {
        day: 3,
        ...
        details: [
          ...
          'Free time for local shopping or optional visit to Har Ki Pauri',
          'Check out and drop at Haridwar railway station / bus stand'
        ]
      }
    ],
    inclusions: [
      '2 Nights accommodation in Haridwar',
      'Daily breakfast & dinner',
      'All sightseeing & transfers by private cab',
      'Driver allowance, toll, parking & fuel',
      'All applicable hotel taxes'
    ],
    exclusions: [
      'Train / air fare',
      'Ropeway & rafting charges',
      'Entry fees at temples / monuments',
      'Personal expenses'
    ],
    activities: ['Temple visits', 'Spiritual exploration', 'Adventure activities', 'Cultural tours'],
    bestFor: 'Short breaks and spiritual seekers'
  },
  {
    id: 3,
    title: '3 Nights / 4 Days Nainital – Jim Corbett Tour Package',
    shortTitle: 'Nainital - Jim Corbett Adventure',
    duration: '3 Nights / 4 Days',
    ...
    itinerary: [
      {
        ...
        details: [
          'Arrive at Kathgodam railway station / Delhi and drive to Nainital (70 km / 2 hrs)',
          'Check in to hotel and freshen up',
          'Visit Naina Devi Temple, Naini Lake (boating optional), Snow View Point (by cable car)',
          'Nainital Zoo & Mall Road walk, evening free for leisure and shopping',
          'Overnight stay in Nainital'
        ]
      },
      {
        day: 2,
        title: 'Nainital Lake Tour & Nearby Sightseeing',
        details: [
          'After breakfast, enjoy full-day lake tour',
          'Cover Bhimtal, Sattal, Naukuchiatal, Hanuman Garhi Temple',
          'Enjoy scenic views and short walks around the lakes',
          'Return to Nainital for overnight stay'
        ]
      },
      {
        day: 3,
        title: 'Nainital → Jim Corbett National Park (65 km / 2 hrs)',
        details: [
          'After breakfast, drive to Jim Corbett',
          'Check in to resort and relax near the forest area',
          'Visit Garjiya Devi Temple and Corbett Museum',
          'Evening free for resort activities & bonfire (subject to weather)',
          'Overnight stay at Corbett resort'
        ]
      },
      {
        day: 4,
        ...
        details: [
          'Early morning Jeep Safari in Corbett National Park (on direct payment)',
          'Explore wildlife including elephants, deer, and Royal Bengal Tiger!',
          'Return to resort for breakfast',
          'Check out and drive back to Kathgodam / Delhi'
        ]
      }
    ],
    inclusions: [
      '3 Nights accommodation (2N Nainital + 1N Corbett)',
      'Daily breakfast & dinner',
    ...
    exclusions: [
      ...
      'Boating / Ropeway fees',
      'Personal expenses'
    ],
    activities: ['Wildlife safari', 'Lake tours', 'Temple visits', 'Nature walks'],
    bestFor: 'Wildlife enthusiasts and adventure lovers'
  },
  {
    id: 4,
  ...
  },
  {
    ...
    inclusions: [
      '5 Nights accommodation (2N Mussoorie + 2N Nainital + 1N Corbett)',
      'Daily breakfast & dinner',
      'Private cab for entire tour (sightseeing + transfers)',
      'Driver allowance, toll, parking & fuel',
      'All applicable hotel taxes'
    ],
    exclusions: [
