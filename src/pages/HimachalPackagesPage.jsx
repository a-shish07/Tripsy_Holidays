          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-xs font-bold text-white tracking-widest">MOUNTAIN PARADISE</span>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-600">(2,500+ reviews)</span>
                </div>
              </motion.div>
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-display font-black bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">₹15,000</p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="relative rounded-3xl border border-black/60 bg-white/80 backdrop-blur-sm p-12 text-center space-y-8 overflow-hidden group">
            ...
            <div className="relative space-y-6">
              ...
              <motion.p 
                ...
                transition={{ delay: 0.3 }}
              >
                Book your adventure today and create unforgettable memories in the Himalayas. Let our experts craft the perfect mountain getaway for you.
              </motion.p>
