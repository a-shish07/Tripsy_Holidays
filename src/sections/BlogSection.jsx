    ...
    <Container id="blog">
      <div className="mb-16 space-y-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mx-auto max-w-3xl space-y-4 rounded-2xl border border-black/10 bg-gradient-to-r from-ocean/5 via-primary/5 to-ocean/5 p-8 backdrop-blur"
        >
          ...
          <button
            ...
            className={`px-6 py-3 rounded-full text-sm font-semibold uppercase tracking-[0.2em] transition-all duration-300 ${
              selectedCategory === category
                ...
                : 'border border-black/20 text-white/70 hover:text-white hover:border-black/40 bg-white/5 hover:bg-white/10'
            }`}
          >
            {category}
          </button>
      ...
      <div className="mt-16 grid gap-8 md:grid-cols-3">
        {filteredPosts.map((post, index) => (
          <motion.article
            ...
            className="group flex h-full flex-col rounded-3xl border border-black/10 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur hover:border-ocean/50 hover:from-white/15 hover:to-white/8 transition-all duration-300 shadow-lg hover:shadow-ocean/20 overflow-hidden"
          >
      ...
      <motion.div
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
        className="mt-16 rounded-3xl border border-black/10 bg-gradient-to-r from-primary/10 via-ocean/10 to-primary/10 p-8 md:p-12 text-center backdrop-blur"
      >
